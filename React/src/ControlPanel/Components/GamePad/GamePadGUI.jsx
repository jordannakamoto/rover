...
function GamepadVisualizer() {
        ...
        useEffect(() => {
          const handleConnect = (event) => {
            ...
            setButtons(event.gamepad.buttons);
            setAxes(event.gamepad.axes);
          };
        ...
        // Game Loop to update button and axis states
        useEffect(() => {
          const gameLoop = () => {
        ...
        <div id="GamePadGUI">
                ...
                <div id="controller-connected" class="controller-status">Connected</div>
                        ...
                        <div>
                                ...
                                <div key={index}>
                                Button {index}: {button.pressed ? 'Pressed' : 'Released'}
                                </div>
                                ))}
                        </div>
                        <div>
                                {axes.map((axis, index) => (
                                <div key={index}>Axis {index}: {axis.toFixed(4)}</div>
                                ))}
                        </div>
                </div>
